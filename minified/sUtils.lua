...
string.gmatch(g,"([^"..k.."]+)")do table.insert(q,j)end return q end local
function x(z)e(1,z,"string")local E=0 for T in io.lines(z)do E=E+1 end return E
end local function A(O)return O%2==0 end local function
